---
title: La Maldición
description: "Card game competitivo en desarrollo, con build jugable pública en itch.io. Consumidor principal de los packages de AgasKhan."
...
<section class="hero">
  ...
  <p class="lead">Card game competitivo por turnos, en desarrollo activo. Consumidor principal de los packages de la biblioteca AgasKhan.</p>
...
La Maldición es el **consumidor principal** de <a href="{{ '/es/projects/common-package/' | relative_url }}">Common-Package</a>: valida los packages contra un juego real y consume sólo los necesarios, referenciados por Git URL + tag en `Packages/manifest.json` a medida que se estabilizan. Es el bucle de feedback entre la biblioteca y un producto en producción.
