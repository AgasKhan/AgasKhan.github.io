...
<section class="hero">
  ...
  <p class="lead">{{ visible_packages.size }} {{ t.packages.intro_with_count_prefix }} <a href="{{ '/es/about/' | relative_url }}">Common-Package</a>{{ t.packages.intro_with_count_suffix }} <code>manifest.json</code>.</p>
  {% else %}
