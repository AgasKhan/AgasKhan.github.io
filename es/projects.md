---
title: Proyectos
description: Proyectos personales y de equipo, con write-ups técnicos.
...
<div class="callout">
  ...
  <p>{{ t.projects.capabilities_note }} <a href="{{ '/es/playground/' | relative_url }}">{{ t.nav.playground }} →</a></p>
</div>
