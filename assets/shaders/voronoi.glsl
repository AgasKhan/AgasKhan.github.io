...
// ------------------------------------------------------------
// Voronoi F1/F2 — returns (f1, f2, closestCellId)
// f1 = distance to closest feature point
...
void main() {
  ...
  // Edge mask: 1 on the line between two cells, 0 deep in a cell.
  float edge_dist     = f2 - f1;
  float line_thickness = 0.035;
  float line          = 1.0 - smoothstep(0.0, line_thickness, edge_dist);
